...
vim.keymap.set({ "n", "v", "o" }, [[fj"]], function()
  findOne("f", { "「", "『", "』", "」" })
end)
vim.keymap.set({ "n", "v", "o" }, [[Fj"]], function()
  findOne("F", { "」", "』", "『", "「" })
end)
vim.keymap.set({ "n", "v", "o" }, [[tj"]], function()
  findOne("t", { "「", "『", "』", "」" })
end)
vim.keymap.set({ "n", "v", "o" }, [[Tj"]], function()
  findOne("T", { "」", "』", "『", "「" })
...
vim.keymap.set("n", "<C-C>", [[<Cmd>lua vim.lsp.buf.code_action()<CR>]])
vim.keymap.set("n", "<C-K>", [[<Cmd>lua vim.lsp.buf.hover()<CR>]])
vim.keymap.set("n", "<C-R>", [[<Cmd>lua vim.lsp.buf.rename()<CR>]])
